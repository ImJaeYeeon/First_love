...
image background_room ="room.jpg"
...
image boy1 = im.FactorScale("character/Uju/Uju_normal.png",0.2)
image boy2 = im.FactorScale("character/Jinhyeok/Jinhyeok_normal.png",0.2)
image boy3 = im.FactorScale("character/Seounghyeon/Seounghyeon_normal.png",0.2)

image boy1 2 = im.FactorScale("character/Uju/Uju_letDown.png",0.2)
image boy1 3 = im.FactorScale("character/Uju/Uju_unsmile.png",0.2)
image boy1 4 = im.FactorScale("character/Uju/Uju_unsmile2.png",0.2)
image boy1 5 = im.FactorScale("character/Uju/Uju_smile.png",0.2)
image boy1 6 = im.FactorScale("character/Uju/Uju_smile2.png",0.2)

image boy2 2 = im.FactorScale("character/Jinhyeok/Jinhyeok_letDown.png",0.2)
image boy2 3 = im.FactorScale("character/Jinhyeok/Jinhyeok_worry.png",0.2)
image boy2 4 = im.FactorScale("character/Jinhyeok/Jinhyeok_shy.png",0.2)

image boy3 2 = im.FactorScale("character/Seounghyeon/Seounghyeon_shy.png",0.2)
image boy3 3 = im.FactorScale("character/Seounghyeon/Seounghyeon_panic.png",0.2)
...
label start:
    ...
    play music "audio/morning.mp3" fadein 2.0
    play sound "audio/sound/alarm.mp3"
